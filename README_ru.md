...
![Открыт к Junior-позициям](https://img.shields.io/badge/Junior_AI%2FML-позиции-Открыт-22C55E?style=for-the-badge&labelColor=14532D)
![Удалённо, гибридно или в офисе](https://img.shields.io/badge/Формат-Удалённо%2Fгибрид%2Fофис-3B82F6?style=for-the-badge&labelColor=172554)
...
flowchart LR
    ...
    A --- A1[✅ Движок autodiff]
    A --- A2[✅ Векторная БД HNSW]
    B --- B1[✅ HTTP-сервер]
    B --- B2[🔜 Мультиплексор терминала]
    C --- C1[✅ Хранилище секретов]
    C --- C2[🔜 P2P-синхронизация]
```
...
<a href="https://github.com/zuroking"><img src="https://img.shields.io/badge/Подписаться_на_GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="Подписаться на GitHub" /></a>
