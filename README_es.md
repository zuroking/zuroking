...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0F172A,50:1D4ED8,100:7C3AED&height=210&section=header&text=Aldiyar%20%28Zuro%29&fontSize=58&fontColor=FFFFFF&fontAlignY=35&desc=Ingeniero%20AI%2FML%20en%20formaci%C3%B3n%20%C2%B7%20Construyendo%20desde%20los%20primeros%20principios&descAlignY=58&descSize=18&animation=fadeIn" />
...
<a href="https://github.com/zuroking">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=19&pause=1200&color=60A5FA&center=true&vCenter=true&width=760&lines=Entendiendo+la+mec%C3%A1nica%2C+no+solo+llamando+a+una+API;Transformers+%C2%B7+autodiff+%C2%B7+HNSW+%C2%B7+systems+programming;Aprendiendo+con+IA%2C+construyendo+con+intenci%C3%B3n;Un+proyecto+from-scratch+a+la+vez" alt="Resumen del perfil" />
</a>
...
[![Email](https://img.shields.io/badge/Email-Contacto-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:zuroking69@gmail.com)

<br>

![Abierto a roles junior](https://img.shields.io/badge/Roles_Junior_AI%2FML-Abierto-22C55E?style=for-the-badge&labelColor=14532D)
![Remoto, híbrido o presencial](https://img.shields.io/badge/Modalidad-Remoto%2FHíbrido%2FPresencial-3B82F6?style=for-the-badge&labelColor=172554)
...
| [**os-scheduler-sim**](https://github.com/zuroking/os-scheduler-sim) | Simulador de planificadores que cubre Round Robin, planificación por prioridad y MLFQ con visualización en diagramas de Gantt | Conceptos de sistemas operativos: algoritmos de planificación y sus compromisos |
...
```mermaid
flowchart LR
    A[Fundamentos de ML] --> B[Programación de sistemas]
    B --> C[Redes y seguridad]
    C --> D[Ingeniero de IA]

    B --- B1[🔜 Multiplexor de terminal]
    C --- C2[🔜 Sincronización de archivos P2P]
```

| Estado | Próximo proyecto | Objetivo |
|---|---|---|
| 🔜 | `terminal-multiplexer` | Construir un multiplexor tipo tmux con sesiones y paneles divididos |
| 🔜 | `p2p-file-sync` | Construir sincronización de archivos P2P cifrada con diffs por chunks y resolución de conflictos |
...
<a href="https://github.com/zuroking"><img src="https://img.shields.io/badge/Seguir_en_GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="Seguir en GitHub" /></a>
<a href="https://t.me/Zuroking"><img src="https://img.shields.io/badge/Mensaje_en_Telegram-26A5E4?style=for-the-badge&logo=telegram&logoColor=white" alt="Mensaje en Telegram" /></a>
